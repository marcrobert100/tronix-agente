...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        self.setWindowTitle("TRONIX AI — Control HUD")
    ...
    def _build_header(self) -> QWidget:
        ...
        lay.addWidget(_badge("TRONIX AI", C.PRI_DIM))
        lay.addStretch()
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl("PCsoluções  ·  TRONIX AI  ·  Viçosa-AL  ·  CLASSIFIED"))
        lay.addStretch()
    ...
    def _on_setup_done(self, key: str, os_name: str):
        ...
        cfg.update({
            ...
            "os_system": os_name,
            "assistant_name": cfg.get("assistant_name", "TRONIX"),
            "user_name": cfg.get("user_name", "Marcos"),
        ...
        if self._overlay:
            ...
            self._overlay = None
        self._apply_state("LISTENING")
        self._log.append_log(f"SYS: Initialised. OS={os_name.upper()}. TRONIX online.")
