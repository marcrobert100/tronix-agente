# Script PowerShell para configurar o OpenClaude com a API da OpenRouter
# Execute este script no mesmo terminal onde você executa o openclaude

Write-Host "Configurando OpenClaude com a API da OpenRouter..." -ForegroundColor Green

# Configurar variáveis de ambiente para o OpenClaude usar a API da OpenRouter
